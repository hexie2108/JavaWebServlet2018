...
public interface ProductDAO extends DAO<Product, Integer>
{
        ...
        /**
         * Returns the number of {@link Product product} stored on the
        ...
        /**
         * Persists the new product passed as parameter to the storage system.
         *
        ...
        /**
         * Returns the {@link Product product} with the primary key equals to
        ...
        /**
         * Returns the list of all the valid {@link Product product} stored by
         * the storage system.
         *
        ...
        /**
         * gel lista di prodotto di una determina categoria in base a id
         * decrescente
         *
        ...
        /**
         * trovare i prodotti pubblici corrispondenti dato un nome di prodotto
         * (with incomplete name, misspelling, ...)
         *
         * @param name nome da ricercare
         * @param order indicare ordinamento, può essere "categoryName" o
         * "productName"
         * @param index l'indice in cui inizia a prendere
         * @param number quantità che vuoi ottenere
        ...
        /**
         * Finds all public product given a text to search in the name or
         * description of the product(with incomplete name, misspelling, ...)
         *
         * @param toSearch text to search in name or description of the product
         * @param order used to select the field for which the results are
         * ordered. can be {"categoryName", "productName", "relevance"}
         * @param direction direction of the sort(big to small, small to big.
         * can be {"asc", "desc"}
        ...
        /**
         * get lista di prodotto dal log , in cui non è stato ancora inviato
         * email , di un specifico utente
         *
         * @param userId id utente
         * @param currentTime user corrente
         * @param predictionDay se la previsione di riaqsuito è minore tale
         * numero di giorno, invoca funzione
        ...
        /**
         * Get a list of common tokens in the products name that can be found
         * with a query(with a relevance score) using a specific list(or null
         * for no specific list)
         *
         * @param query string to search
         * @param list id of the list(optional) to use together with the default
         * products
         * @param categories list of categories to consider(if empty all are
         * considered)
         * @return list of common tokens in the products name(with a relevance
         * score)
         * @throws DAOException
         */

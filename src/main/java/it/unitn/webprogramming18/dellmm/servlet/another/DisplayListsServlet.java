...
public class DisplayListsServlet extends HttpServlet
{
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
        {
                ...
                else
                {
                        ...
                        HashMap<ShoppingList, List<Product>> completeOwnedLists
                                    = (HashMap<ShoppingList, List<Product>>) new HashMap();

                        for (ShoppingList l : ownedLists)
                        {
                        ...
                        //Structure: HashMap<listBean, List<productBean>>
                        HashMap<ShoppingList, List<Product>> completeSharedLists
                                    = (HashMap<ShoppingList, List<Product>>) new HashMap();

                        for (ShoppingList l : sharedLists)
                        {

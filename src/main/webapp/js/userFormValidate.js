...
function validateRegister() {
        ...
        //se è vuoto o ha un valore  diverso da quella stabilità
...
/**
 * validatore per form di modify User
 * @returns {Boolean}
 */
function validateModify() {
        ...
        if (password !== "")
        {
                ...
                //se supera la lunghezza massima o se è troppo corta 
                if (password.length > 44 || password.length < 8)
                {
                        var errorType = "null";
        ...
        var arrayOfDefaultAvatar = ["user.svg", "user-astronaut.svg", "user-ninja.svg", "user-secret.svg", "custom"];
        //se non è vuoto 
        if (avatar !== underfined)
        {
                //se è diverso da password
                if (arrayOfDefaultAvatar.indexOf(avatar) === -1)
                {
                        var errorType = ".invalid";

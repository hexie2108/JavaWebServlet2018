...
// Se false l'invio del form verr� bloccato altrimenti no
...
// Se l'estensione per leggere i file � supportata faccio il controllo altrimenti no
// (fatto successivamente dal server)
if (!window.FileReader) {
return data;
}

// Se il browser ha l'estensione che permette di accedere alla propriet� files continuo altrimenti no
// (fatto successivamente dal server)

...
<div id="notificationsEmtpy" class="p-2" <c:if test="${not notifications.isEmpty()}">style="display: none"</c:if>"><fmt:message key="notifications.label.noNotifications"/></div>

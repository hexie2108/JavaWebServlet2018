...
<div>
    <form id="form-register" name="form-register" method="post" enctype="multipart/form-data" autocomplete="off"
        ...
        <div class="form-group row ">
            ...
            <div id="divEmail" class="email-group col-sm-12">
                ...
                <div class="input-group">
                    ...
                    <input id="inputEmail" class="form-control input-box"
                           placeholder="<fmt:message key="user.label.email"/>" required=""
                           ...
                           title="suggerimenti"
                           data-content=" la lunghezza deve essere limitata a ${RegistrationValidator.EMAIL_MAX_LEN}">
                ...
                <div class="error-messages error-email">
                    <p class="null">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.EMAIL_MISSING"/>
                    </p>
                    <p class="max-length">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.EMAIL_TOO_LONG"/>
                    </p>
                    <p class="invalid">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.EMAIL_NOT_VALID"/>
                    </p>
                    <p class="repeat">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.EMAIL_ALREADY_USED"/>
                    </p>
        ...
        <div class="form-group row ">
            ...
            <div class="first-name-group col-sm-6 ">
                ...
                <div class="input-group ">
                    ...
                    <input id="inputFirstName" class="form-control input-box"
                           placeholder="<fmt:message key="user.label.name"/>" required=""
                ...
                <div class="error-messages error-first-name">
                    ...
                    <p class="null">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.FIRST_NAME_MISSING"/>
                    </p>
                    <p class="max-length">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.FIRST_NAME_TOO_LONG"/>
                    </p>
            ...
            <div class="last-name-group col-sm-6 ">
                ...
                <div class="input-group">
                    ...
                    <input id="inputLastName" class="form-control input-box"
                           placeholder="<fmt:message key="user.label.surname"/>" required=""
                ...
                <div class="error-messages error-last-name">
                    ...
                    <p class="null">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.LAST_NAME_MISSING"/>
                    </p>
                    <p class="max-length">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.LAST_NAME_TOO_LONG"/>
                    </p>
        ...
        <div class="form-group row">
            ...
            <div id="divPassword" class="password-group col-sm-6">
                ...
                <div class="input-group">
                    ...
                    <input id="inputPassword" class="form-control input-box"
                ...
                <div class="error-messages error-password">
                    ...
                    <p class="null">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD_MISSING"/>
                    </p>
                    <p class="max-length">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD_TOO_LONG"/>
                    </p>
                    <p class="min-length">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD_TOO_SHORT"/>
                    </p>
                    <p class="invalid">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD_NOT_VALID"/>
                    </p>
            ...
            <div id="divPassword2" class="password2-group col-sm-6">
                ...
                <div class="input-group">
                    ...
                    <input id="inputPassword2" class="input-box form-control"
                ...
                <div class="error-messages error-password2">
                    ...
                    <p class="null">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD2_MISSING"/>
                    </p>
                    <p class="no-equal">
                        <i class="fas fa-exclamation-triangle"></i> <fmt:message
                            key="validateUser.errors.PASSWORD2_NOT_SAME"/>
                    </p>
        ...
        <div class="avatar-group form-group">
            ...
            <div class="">
                <c:forEach items="${RegistrationValidator.DEFAULT_AVATARS}" var="av" varStatus="status">
                    ...
                    <div class="avatar-box custom-control custom-radio custom-control-inline">
                        <input type="radio" class="custom-control-input  img-radio default-avatar"
                               id="avatar-${status.index}" name="${RegistrationValidator.AVATAR_KEY}"
                               value="${av}" ${status.index==0?"checked":""} required="required"/>
                        <label class="custom-control-label" for="avatar-${status.index}">
                            <img class="img-input img-fluid"
                                 src="<c:url value="/${ConstantsUtils.IMAGE_BASE_PATH}/${ConstantsUtils.IMAGE_OF_USER}/${av}"/>"/>
                ...
                <div class="avatar-box custom-control custom-radio custom-control-inline">
                    <input type="radio" class="custom-control-input  img-radio" id="avatar-custom"
                           name="${RegistrationValidator.AVATAR_KEY}" value="custom" required="required"/>
                    <label class="custom-control-label" for="avatar-custom">
                        <img class="img-input img-fluid"
                             src="<c:url value="/${ConstantsUtils.IMAGE_BASE_PATH}/base/custom-avatar.svg"/>"/>
                        <span class="img-check">
                                                        <i class="far fa-check-circle "></i>
                                                </span>
                    </label>
            ...
            <div class="error-messages error-avatar">
                ...
                <p class="invalid">
                    <i class="fas fa-exclamation-triangle"></i> <fmt:message
                        key="validateUser.errors.AVATAR_NOT_VALID"/>
                </p>
            </div>
        ...
        <div class="form-group custom-avatar-uploader">
            ...
            <div class=" custom-file input-group mb-3">
                ...
                <input type="file" class="custom-file-input" id="customAvatarImg"
                       name="${RegistrationValidator.AVATAR_IMG_KEY}"
            ...
            <div class="error-messages error-custom-avatar-img">
                ...
                <p class="null">
                    <i class="fas fa-exclamation-triangle"></i> <fmt:message
                        key="validateUser.errors.AVATAR_IMG_MISSING"/>
                </p>
                <p class="max-length">
                    <i class="fas fa-exclamation-triangle"></i> <fmt:message
                        key="validateUser.errors.AVATAR_IMG_TOO_BIG"/>
                </p>
                <p class="min-length">
                    <i class="fas fa-exclamation-triangle"></i> <fmt:message
                        key="validateUser.errors.AVATAR_IMG_ZERO_DIM"/>
                </p>
                <p class="invalid">
                    <i class="fas fa-exclamation-triangle"></i> <fmt:message
                        key="validateUser.errors.AVATAR_IMG_NOT_IMG"/>
                </p>
        ...
        <div class="form-group row-fluid">
            ...
            <div id="divPrivacy">
                <div class="input-group custom-control custom-checkbox">
                    <input id="inputInfPrivacy" class="custom-control-input" type="checkbox"
                           name="${RegistrationValidator.INF_PRIVACY_KEY}">
